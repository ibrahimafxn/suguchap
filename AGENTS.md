...
## 4.1) Avancement (etat au 2026-02-28)
- Sprint 0 : termine (cadrage + decisions stack + backlog initial documentes)
- Sprint 1 : termine (backend NestJS + schema DB + auth OTP mock + endpoints + Swagger)
- Sprint 2 : a faire
- Sprint 3 : a faire
- Sprint 4 : a faire
- Sprint 5 : a faire
...
- Construire l'onboarding (ville, adresse, telephone)
- Liste des marches + selection
- Catalogue produits + panier
- Creation commande depuis le panier (API)
